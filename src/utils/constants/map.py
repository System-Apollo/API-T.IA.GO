...
categoria_perguntas['quantidade_processos_comarca'] = [
    r"quantidade de processos por municipio",
    r"quantos processos existem em cada municipio",
    r"numero de processos por municipio",
    r"quantos processos por municipio",
]
